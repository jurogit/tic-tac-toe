...
$(document).ready(function() {
  ...
  // Button Events
  $("#select .choice .button").click(function() { // player type selector
  ...
  $("#go").click(function() { // go / reset button
    resetScore();
    init();
  });

  $("#reset").click( function() { // go / reset button
    init();
  });

  $("#board canvas").click(function() { // game space click
